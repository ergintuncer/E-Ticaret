            ...
            <asp:UpdatePanel ID="pnlHelloWorld" runat="server">
                <ContentTemplate>--%>
                    ...
                    <div class="line">
                        ...
                        <div class="lineSagDiv">
                            <asp:DropDownList ID="drpGonderen" runat="server" CssClass="drplist" AutoPostBack="False" OnTextChanged="drpGonderen_OnTextChanged" >
                    ...
                    <div class="line">
                        ...
                        <div class="lineSagDiv">
                            <asp:DropDownList ID="drpAlici" runat="server" CssClass="drplist" AutoPostBack="False"  OnTextChanged="drpAlici_OnTextChanged" >
                    ...
                    <div class="lineOrta">
                        <asp:Button ID="btnkayit"  CssClass="btn btn-success" runat="server" Text="Kaydet" OnClick="btnkayit_OnClick"/>
                       <%-- <button runat="server" id="btnKaydet" class="button" OnServerClick="btnKaydet_OnServerClick" Text="Kaydet">
                            --%>
                ...
                <ItemTemplate>
                    <div class="ListeDiv">
                        ...
                        <div class="line">
                            ...
                            <div class="lineSagDiv">
                                <asp:Label ID="lbladresadi" runat="server" Text='<%#Eval("gonderici") %>'></asp:Label>
                            </div>
                        </div>
                        <div class="line">
                            <div class="lineSolDiv">
                            ...
                            <div class="lineSagDiv">
                                <asp:Label ID="lbladres" runat="server" Text='<%#Eval("bankahesapad") %>'></asp:Label>
                            </div>
                        </div>
                        <div class="line">
                            <div class="lineSolDiv">
