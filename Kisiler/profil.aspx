<%@ Page Title="Profil" Language="C#" MasterPageFile="~/KisiMaster.master" AutoEventWireup="true" CodeFile="profil.aspx.cs" Inherits="Kisiler_profil" %>
...
<div class="line">
    ...
    <div class="lineSagDiv">
        <input class="TexBoxCss" id="txtTcNo" type="text" placeholder="Tck" maxlength="11" autocomplete="off" runat="server" readonly/>
    </div>
</div>
<div class="line">
    <div class="lineSolDiv">
